...
public class CrossBrowserTesting {
	...
	public void browserLaunch(String browser) 
	{
		...
		if(browser.equalsIgnoreCase("firefox")){ 
		  System.setProperty("webdriver.gecko.driver", "D:\\AutomationAug2022\\TestNGMaven\\drivers\\geckodriver.exe"); 
		  driver = new FirefoxDriver();
		  System.out.println("firefox opened succesfully"); 
	    }else if (browser.equalsIgnoreCase("chrome")){ 
		System.setProperty("webdriver.chrome.driver", "D:\\AutomationAug2022\\TestNGMaven\\drivers\\chromedriver.exe"); 
		driver = new ChromeDriver();
		System.out.println("chrome opened succesfully"); 
     	}else if(browser.equalsIgnoreCase("edge")){
		System.setProperty("webdriver.edge.driver", "D:\\AutomationAug2022\\TestNGMaven\\drivers\\msedgedriver.exe");
